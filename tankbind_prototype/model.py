            ...
            if self.session_type=="session_ap" and self.training:#batch内所有样本蛋白一样
                ...
                for tmp_idx,protein_edge_index_t in enumerate(protein_edge_index_t_batched_):
                    if tmp_idx==0:
                        ...
                        continue
                    protein_edge_index_t_batched.append(protein_edge_index_t-sum(sample_node_num_batched[:tmp_idx]))
                ...
                for pdb_idx,pdb_id in enumerate(p_pdb_id_list):
                    ...
                    for_log_list.append((len(protein_node_s_batched[idx]),protein_node_s_batched[idx].shape[0]))
