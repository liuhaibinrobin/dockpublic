...
def main(args, _model_epoch_id):
    ...
    pre = f"/home/jovyan/dataspace/Inner/dataset/{args.compound_name}"
    ...
    if args.iter == 0:
        modelFile = "/home/jovyan/main_tankbind/saved_models/self_dock.pt"
    elif args.iter == 1:
        modelFile = "/home/jovyan/main_tankbind/datasets/reproduce1/models/epoch_189.pt"
    elif args.iter == 2:
        modelFile = "/home/jovyan/main_tankbind/datasets/reproduce2/models/epoch_136.pt"
    elif args.iter == 3:
        modelFile = "/home/jovyan/main_tankbind/datasets/reproduce3/models/epoch_110.pt"
    
    if args.folder == "original":
        modelFile = "/home/jovyan/main_tankbind/saved_models/self_dock.pt"
    
    elif args.folder != "":
        modelFile = f"/home/jovyan/main_tankbind/tankbind/result/{args.folder}/models/epoch_{args.iter}.pt"
    ...
    dataset = TBDataset(root=f'data_{args.folder}/{args.compound_name}',df_tr=df_tr, df_te=df_te, df_va=df_va)
    ...
    with torch.no_grad():
        ...
        for index, row in df.iterrows():
            ...
            df.iloc[index] = row
        csv_name = f'/home/jovyan/main_tankbind/outputs/{args.compound_name}'
        if not os.path.exists(csv_name):
            os.system(f"mkdir -p {csv_name}")
        df.to_csv(f'{csv_name}/{args.folder}_model_{args.iter}_aff.csv', index=False,encoding='utf-8')
        print('TEST----> score: {}' .format(score))
        with open(f"/home/jovyan/main_tankbind/outputs/{args.compound_name}/{args.folder}_iter_{args.iter}_score_{score}.txt", 'w') as f:
            f.write("----")
    return score
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", type=str, default='/home/jovyan/dataspace/Inner/dataset')
    ...
    os.system(f"rm -rf /home/jovyan/main_tankbind/tankbind/data_{args.folder}")
    dic = {}
    # Original
    # 1
    # 2
