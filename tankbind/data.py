...
def get_data(data_mode, logging, addNoise=None):
    ...
    if data_mode == "-1":
        logging.info(f"re-docking, using dataset generated by its ipynb : apr22_pdbbind_gvp_pocket_radius20 pred distance map.")
        ...
        new_dataset = TankBindDataSet(f"{pre}/../../data/pdbbind2020/dataset/", add_noise_to_com=add_noise_to_com)
