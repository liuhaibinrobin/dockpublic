...
def get_data(data_mode, logging, addNoise=None):
    ...
    if data_mode == "0":
        ...
        # only_native_train_index = d.query(
        #     f"use_compound_com and group =='train' and pdb not in {l_rotate_30} and pdb != '4q3r'").index.values
        # only_native_train_index = d.query(
        #     "use_compound_com and group =='train' and pdb in ( '5mnc','5u7m','2nno','5j87','5uwf','4mrf','4kju','3eta','2b54','5nzp' )").index.values
